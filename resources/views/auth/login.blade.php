            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group custom-input-group">
                        ...
                        <input id="email" type="email" class="form-control ps-1 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="name@example.com">
                        @error('email')
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group custom-input-group">
                        ...
                        <input id="password" type="password" class="form-control ps-1 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Enter your password">
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="text-center">
                    <p class="small text-secondary mb-0">
                        Belum punya akun? <a href="{{ route('register') }}" class="text-decoration-none fw-medium">Daftar Warga</a>
                    </p>
                </div>
            </form>
        </div>
