                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap text-center">
                                <button type="button" class="btn btn-sm btn-icon-action" data-bs-toggle="modal" data-bs-target="#deleteModal" data-action="{{ route('mutasi.destroy', $m->id) }}" title="Hapus" aria-label="Hapus">
